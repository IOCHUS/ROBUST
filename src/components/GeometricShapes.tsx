...
const GeometricShapes = () => {
  return (
    <div className="absolute inset-0 pointer-events-none z-[15] overflow-visible">
      ...
      {/* Hero Section */}
      <div className="absolute top-20 -right-32 w-80 h-80 opacity-5">
        <div className="absolute inset-0 bg-gradient-to-br from-amber-400 to-transparent rounded-full blur-3xl"></div>
      </div>

      <div className="absolute top-[600px] -left-40 w-96 h-96 opacity-4">
      ...
      <div className="absolute top-[900px] -left-36 w-88 h-88 opacity-4">
      ...
      {/* Core Pillars Area */}
      <div className="absolute top-[1250px] -right-40 w-96 h-96 opacity-5">
        <div className="absolute inset-0 bg-gradient-to-bl from-purple-500 to-transparent rounded-full blur-3xl"></div>
      </div>

      <div className="absolute top-[1600px] -left-32 w-80 h-80 opacity-5">
      ...
      {/* Modules Area */}
      <div className="absolute top-[2050px] -right-36 w-92 h-92 opacity-5">
      ...
      <div className="absolute top-[2850px] -left-32 w-72 h-72 opacity-4">
        <div className="absolute inset-0 bg-gradient-to-br from-cyan-400 to-transparent rounded-full blur-3xl"></div>
      </div>
      ...
      {/* Transformation Area */}
      <div className="absolute top-[3150px] -right-40 w-96 h-96 opacity-5">
        <div className="absolute inset-0 bg-gradient-to-bl from-amber-400 to-transparent rounded-full blur-3xl"></div>
      </div>

      <div className="absolute top-[3500px] -left-28 w-80 h-80 opacity-4">
      ...
      <div className="absolute top-[3950px] -right-32 w-84 h-84 opacity-5">
        <div className="absolute inset-0 bg-gradient-to-bl from-rose-400 to-transparent rounded-full blur-3xl"></div>
      </div>
      ...
      {/* Guarantee Area */}
      <div className="absolute top-[4400px] -left-36 w-88 h-88 opacity-5">
        <div className="absolute inset-0 bg-gradient-to-tr from-cyan-400 to-transparent rounded-full blur-3xl"></div>
      </div>

      <div className="absolute top-[4650px] -right-36 w-88 h-88 opacity-4">
        <div className="absolute inset-0 bg-gradient-to-bl from-amber-400 to-transparent rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="absolute top-[5100px] -left-32 w-80 h-80 opacity-5">
        <div className="absolute inset-0 bg-gradient-to-br from-purple-500 to-transparent rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="absolute top-[5450px] -right-40 w-96 h-96 opacity-5">
        <div className="absolute inset-0 bg-gradient-to-bl from-rose-400 to-transparent rounded-full blur-3xl"></div>
      </div>
