...
const GeometricShapes = () => {
  return (
    <div className="absolute inset-0 pointer-events-none z-[15] overflow-visible">
      ...
      {/* Hero Section - Subtle top corners */}
      ...
      <div className="absolute top-[450px] -left-24 w-64 h-64 opacity-15">
      ...
      <div className="absolute top-[850px] left-[8%] w-32 h-32 opacity-20">
      ...
      {/* Core Pillars Area - Edges only */}
      <div className="absolute top-[1250px] -right-40 w-96 h-96 opacity-15">
      ...
      <div className="absolute top-[2700px] -right-32 w-72 h-72 opacity-18">
      ...
      <div className="absolute top-[2950px] right-[15%] w-36 h-36 opacity-18">
        <svg viewBox="0 0 100 100" className="w-full h-full">
      ...
      <div className="absolute top-[3850px] right-[8%] w-44 h-44 opacity-20">
        <svg viewBox="0 0 100 100" className="w-full h-full">
      ...
      <div className="absolute top-[4100px] right-[20%] opacity-18">
        <div className="w-1.5 h-1.5 bg-purple-300 rounded-full"></div>
      </div>

      {/* Guarantee Area - Subtle accents */}
      <div className="absolute top-[4500px] -right-36 w-88 h-88 opacity-15">
        <div className="absolute inset-0 bg-gradient-to-bl from-amber-400 to-transparent rounded-full blur-3xl"></div>
      </div>

      <div className="absolute top-[4850px] left-[7%] w-40 h-40 opacity-18">
        <svg viewBox="0 0 100 100" className="w-full h-full">
