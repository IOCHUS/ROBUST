...
const GeometricShapes = () => {
  return (
    <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
      ...
      <div className="absolute top-20 left-8 w-80 h-screen opacity-40">
      ...
      <div className="absolute top-32 right-12 w-96 h-96 opacity-35">
      ...
      <div className="absolute top-1/2 right-16 w-64 h-80 opacity-40">
      ...
      <div className="absolute bottom-20 left-12 w-72 h-72 opacity-35">
      ...
      <div className="absolute top-1/3 left-1/4 w-32 h-32 opacity-30">
      ...
      <div className="absolute bottom-1/3 right-1/3 w-32 h-32 opacity-30">
        <svg viewBox="0 0 100 100" className="w-full h-full">
